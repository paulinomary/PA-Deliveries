function codemessage = encodemessage(message, alphabet, code)

%encodemessage   Message encoding.
%
%   codemessage = encodemessage(message, alphabet, code) returns the encoded version of 
...
%
%   codemessage = encodemessage(indexmessage, code) returns the encoded version of 
